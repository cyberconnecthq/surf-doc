...
<Tabs>
  <Tab title="Claude Code">
    ...
    - Endpoint: `POST https://api.asksurf.ai/v1/chat/completions`
  ...
  <Tab title="Cursor">
    ...
    - REST API base: https://api.asksurf.ai/gateway
    - Auth: Bearer token from SURF_API_KEY env var (never hardcode)
    - Chat API: POST https://api.asksurf.ai/v1/chat/completions (OpenAI-compatible)
...
4. **Surf Chat API** — for natural language crypto queries
   POST https://api.asksurf.ai/v1/chat/completions
...
resp = requests.get(
    "https://api.asksurf.ai/gateway/market/price",
