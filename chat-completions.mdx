...
```bash
curl -X POST "https://api.ask.surf/gateway/v1/chat/completions" \
...
url = "https://api.ask.surf/gateway/v1/chat/completions"
headers = {
...
```javascript
const url = "https://api.ask.surf/gateway/v1/chat/completions";
